...
return (
    <div>
         <div className="w-full justify-center  items-center">
            ...
            <form onSubmit={handleSubmit(onSubmit)} class="form p-6 my-10 relative" style={{ background: theme.ui, color: theme.syntax }}>
                <h3 class="text-2xl font-semibold">Add Expense</h3>
                ...
                <div class=" w-full flex mb-6">
                    <div class="w-1/4 mr-3">
                        <input value={amount} onChange={(e)=>setAmount(e.target.value)} class="block w-full border p-2 mb-3" type="text" placeholder="Amount" name="amount" />
                    </div>
                    <div class="w-3/4">
                      <DatePicker
