        ...
        <div className="w-full justify-center items-center p-4" style={{ background: theme.ui, color: theme.syntax }} >
            <div className="text-center px-6 py-4">
                <div className="py-8">
                    ...
                    <p className="text-2xl text-grey-darker font-medium mb-4">No Account!</p>
                    <p className="text-grey max-w-xs mx-auto mb-6">Welcome to the accounts section! Please add a new account</p>
                </div>
            </div>
        </div>
